  ...
  return (
    ...
    <header className="App-header">
      ...
      <defs>
        ...
        <Line P1={"H"} P2={"x1"} id="Tx1" after={true} />
        <Line P1={"H"} P2={"x2"} id="Tx2" after={true} />
      </svg>
      </header>
      <snapto id="sliders">
        ...
        <Console id={"Hc2"} text={"point data"} left={300} top={500} parent={()=>document.getElementById("H").me} values={{data:this}}/>
