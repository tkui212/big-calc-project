...
class circle extends body {
  /**
     ...
     * @param {number} ops.vy 
     */
  constructor(x,y,radius,ops){
    super(x,y,ops)
    this.width = ops.width?ops.width:100;
    this.height = ops.height?ops.height:100;
    this.radius = radius;
    this.port=new Point(x,y,{id:`${this.id}P`,parent:this});
