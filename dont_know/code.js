...
function graph(points) {
  ...
  this.draw = function () {
    ...
    line([getMinDX(Opoints), h_2 + mY], [getMaxDX(Opoints), h_2 + mY], 5);//sides 00
    line([mX,getMinDY(Opoints)],[mX,getMaxDY(Opoints)],5)//up down 00
...
function point(x, y) {
  ...
  this.updait=function(){
        /**draw x posisen */
        this.dx = this.dx? mX + this.x * WTX -getMinDX(Opoints):mX + this.x * WTX;
